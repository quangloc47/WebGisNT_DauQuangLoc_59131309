...
<body id="view_user">
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($isValue) {
      ...
      if ($adduser) {
        ...
        echo '<p class="error">Quá trình đăng ký thành công. Tài khoản đã có thể sử dụng!</p>';
      } else {
        echo '<h1>Thông báo</h1>';
  ...
  ?>
  <h1 style="color: green">Đăng ký Admin</h1>
  <div class="con">
    <div class="row justify-content-center">
      <div class="col-lg-7">
        <div class="card shadow-lg border-dark rounded-lg my-3">
          <div class="card-header">
            <h3 class="text-center text-danger font-weight-bold my-1">ĐĂNG KÝ TÀI KHOẢN ADMIN</h3>
          </div>
          <div class="card-body">
            <form action="dki_admin.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-row">
                ...
                <div class="col-md-6">
                  <div class="form-group mt-4 mb-0">
                    <a class="btn btn-primary btn-block" href="view_users3.php">Quay lại</a>
                  </div>
                </div>
              </div>
            </form>
